...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void updateUserInfo() {
        ...
        hashMap.put("profileImage",""); //add empty do later
        hashMap.put("userType","user"); //possible values aer user, admin:  will make admin maually in firebase realtime adtabase by changing this value
